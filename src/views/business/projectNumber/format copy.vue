<template>
  <div class="project-number app-container">
    <!-- dialog-业务编号格式设置 -->
    <el-dialog class="code-dialog" title="业务编号格式设置" :visible.sync="showCodeDialog" width="42%">
            ...
            <el-row type="flex" :gutter="10">
              ...
              <el-col :span="10">
                <div class="set-button">
                  ...
                  <el-button plain icon="el-icon-delete" @click="deleteSetItem">删除</el-button>
                </div>
...
export default class extends Vue {
  ...
  trueValue() {
    ...
    this.$emit('setFormat', this.showInputVal)
  }
  openDialog() {
